...
define( 'GD_MEMCACHE_SOCK',    'unix:///var/chroot/var/tmp/moxi/903.f1e.myftpupload.com.sock' );
#define( 'GD_MEMCACHE_SOCK',    'localhost:11211' );
define( 'WP_CACHE_KEY_SALT',   'v05k9pnjy789tjx4xh6h' );
...
$conf = parse_ini_file( '/web/conf/gd-wordpress.conf' );
if ( false === $conf ) {
	trigger_error( 'Cannot read wordpress configuration' );
} else {
	define( 'GD_SYSTEM_API_ENDPOINT', $conf['api_url'] );
}

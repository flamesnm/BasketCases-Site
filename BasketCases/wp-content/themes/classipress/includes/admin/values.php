 ...
 *
 */
global $options_new_form, $options_new_field, $options_new_ad_pack, $options_new_membership_pack;
	...
	array(	'name' => __( 'Membership Pack Details', APP_TD ),
		...
		array(  'name' => __( 'Name', APP_TD ),
               ...
               array(  'name' => __( 'Description', APP_TD ),
                ...
                array(  'name' => __( 'Price Modifier (How a membership affects the price of an ad)', APP_TD ),

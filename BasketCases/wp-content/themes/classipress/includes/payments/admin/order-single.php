...
class APP_Order_Status extends APP_Meta_Box {
	...
	function __construct(){
		parent::__construct( 'order-status', __( 'Order Status', APP_TD ), APPTHEMES_ORDER_PTYPE, 'side' );
	}
...
class APP_Order_Author extends APP_Meta_Box {
	 ...
	 */
	function __construct(){
		parent::__construct( 'order-author', __( 'Order Author', APP_TD ), APPTHEMES_ORDER_PTYPE, 'side' );
	}

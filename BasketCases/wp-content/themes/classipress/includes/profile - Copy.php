...
function cp_profile_fields_description( $field ) {
	$description = array(
		...
		'facebook_id' =>
			...
			sprintf( ' <a target="_blank" href="http://www.facebook.com/username/">%s</a>', __( 'Get a custom URL.', APP_TD ) ),
	);
...
?>
		...
		<?php
			...
			?>
								...
								<input type="text" name="<?php echo $field_id; ?>_display" id="<?php echo $field_id; ?>" value="<?php echo esc_attr( $display_date ); ?>" class="regular-text" size="35" disabled="disabled" /><br />

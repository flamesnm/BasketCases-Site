			...
			<div class="content_left">
				...
				<div class="shadowblock_out" id="noise">
					...
					<div class="shadowblock">
						...
						<h2 class="dotted"><?php printf( __( 'About %s', APP_TD ), $curauth->display_name ); ?></h2>

						<div class="post" id="noise">

							<div id="user-photo"><?php appthemes_get_profile_pic($curauth->ID, $curauth->user_email, 70); ?></div>

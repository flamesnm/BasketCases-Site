<div id="gmap" class="mapblock">
	...
	<?php
		$make_address = get_post_meta($post->ID, 'cp_street', true) . '&nbsp;<br>' . get_post_meta($post->ID, 'cp_city', true) . '&nbsp; ' . get_post_meta($post->ID, 'cp_state', true) . '&nbsp; ' . get_post_meta($post->ID, 'cp_zipcode', true);

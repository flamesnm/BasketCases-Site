      ...
      <div id="welcome_widget" class="shadowblock_out">
        ...
        <div class="shadowblock">
            ...
            <?php if ( ! is_user_logged_in() ) { ?>
                ...
                <div class="pad2"></div>
                <a href="<?php echo appthemes_get_registration_url(); ?>" class="mbtn btn_orange"><?php _e( 'Join Now!', APP_TD ); ?></a>&nbsp;&nbsp;&nbsp;<a href="<?php echo wp_login_url(); ?>" class="mbtn btn_orange"><?php _e( 'Login', APP_TD ); ?></a>
                <div class="pad5"></div>
